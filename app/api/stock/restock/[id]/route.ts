...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    if (body.expectedRestockLabel !== undefined) updates.expected_restock_label = body.expectedRestockLabel.trim();
    if (body.customerMessage     !== undefined) updates.customer_message      = body.customerMessage.trim();
