...
export const AU_HOLIDAYS: AuHoliday[] = [
  ...
  { date: '2025-05-12', name: 'Adelaide Cup',        scope: 'sa'       }, // 2nd Monday in May
  ...
  { date: '2026-05-11', name: 'Adelaide Cup',        scope: 'sa'       }, // 2nd Monday in May
  { date: '2026-06-08', name: "King's Birthday",    scope: 'sa'       }, // 2nd Monday in June
  { date: '2026-12-25', name: 'Christmas Day',      scope: 'national' },
  { date: '2026-12-28', name: 'Proclamation Day',   scope: 'sa'       }, // observed (26 Dec is Sat)
];
